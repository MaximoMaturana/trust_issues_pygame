...
class Player:
    ...
    def update(self, dt: float, keys, level):
        ...
        # Jump. If both timers are “active”, jump triggers and calls the level hook (used in Level 3).
        ...
        # Movement + collision. Handles axis-separated collision 
        ...
        # This gives stable platform physics.
    def _move_and_collide(self, dt: float, level):

        #  X axis: move X, resolve X collisions
        ...
        # Y axis: move Y, resolve Y collisions
    ...
    def draw(self, surf: pg.Surface, cam: Camera):
        # Draws a stick figure using circles/lines. Uses sine wave to swing arms/legs while moving on ground.
